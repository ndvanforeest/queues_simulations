...
\begin{exercise}
  ...
  Plot the empirical cdf of the merged inter-arrival times, and compare the emperical cdf to the exponential distribution with the correct mean (which should by $\lambda = 3/5$).
